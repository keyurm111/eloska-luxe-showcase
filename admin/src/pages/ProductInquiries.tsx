...
const ProductInquiries = () => {
  ...
  const fetchInquiries = async () => {
    try {
      setLoading(true);
      const response = await productInquiryApi.getAll(
        pagination.page,
        pagination.limit,
        filters
      );
  ...
  const handleStatusChange = async (id: string, status: string, adminNotes?: string) => {
    try {
      await productInquiryApi.updateStatus(id, status, adminNotes);
  ...
  const handleDelete = async (id: string) => {
    ...
    try {
      await productInquiryApi.delete(id);
  ...
  const handleExport = async () => {
    try {
      const blob = await productInquiryApi.export(filters);
      downloadFile(blob, `product-inquiries-${new Date().toISOString().split('T')[0]}.csv`);
  ...
  return (
    <div className="space-y-4 sm:space-y-6">
      ...
      <div className="flex flex-col sm:flex-row sm:justify-between sm:items-center gap-4">
        <div>
          <h1 className="text-xl sm:text-2xl font-bold text-gray-900">Product Inquiries</h1>
      ...
      <div className="card">
        <div className="flex flex-col sm:flex-row gap-4">
          ...
          >
            ...
            <option value="bag-fabric">Bag Fabric</option>
          </select>
        </div>
      </div>
                  ...
                  <tr key={inquiry._id} className="hover:bg-gray-50">
                    ...
                    <td className="table-cell">
                      <div>
                        ...
                        <div className="text-sm text-gray-500">{inquiry.productCode}</div>
                      </div>
                    </td>
                    <td className="table-cell">
                    ...
                    <td className="table-cell">{inquiry.quantity}</td>
                    <td className="table-cell">
                      <select
            ...
            <div key={inquiry._id} className="bg-white rounded-lg shadow-sm border border-gray-200 p-4">
              ...
              <div className="space-y-2">
                <div className="flex justify-between items-center">
                  ...
                  <span className="text-xs font-medium text-gray-900">{inquiry.productName}</span>
                </div>
                <div className="flex justify-between items-center">
                  <span className="text-xs text-gray-500">Code:</span>
                  <span className="text-xs text-gray-700">{inquiry.productCode}</span>
                </div>
                <div className="flex justify-between items-center">
                ...
                <div className="flex justify-between items-center">
                  ...
                  <span className="text-xs font-medium text-gray-900">{inquiry.quantity}</span>
                </div>
                <div className="flex justify-between items-center">
                    ...
                    <div className="space-y-4">
                      ...
                      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                        <div>
                          ...
                          <p className="text-sm text-gray-900">{selectedInquiry.productCode}</p>
                        </div>
                        <div>
